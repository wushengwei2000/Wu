...
namespace Orchard.Comments {
    public class Migrations : DataMigrationImpl {
        ...
        {
            SchemaBuilder.AlterTable("CommentPartRecord", table => table
                .AddColumn<string>("CommentedOnUrl"));

            SchemaBuilder.AlterTable("CommentsPartRecord", table => table.AddColumn<string>("Url"));
            return 7;
        }

        public int UpdateFrom7()
        {
            ContentDefinitionManager.AlterTypeDefinition("Comments", cfg => cfg.WithPart("CommentsPart")
                .WithPart("WidgetPart")
                .WithPart("CommonPart")
        ...
        {
            ContentDefinitionManager.AlterTypeDefinition("Comments Part", cfg => cfg.WithPart("CommentsPart")
                .WithPart("WidgetPart")
                .WithPart("CommonPart")
                .WithSetting("Stereotype", "Widget"));
